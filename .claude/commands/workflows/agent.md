...
6. GENERATE_AGENT_FILE:
   - {{agents.file_creator}}(mode="agent", template="{{templates.agents.agent_template}}")
...
7. REGISTER_IN_VARIABLES:
   - {{agents.file_creator}}(mode="variables_update")
...
9. LOG_COMPLETION:
   - {{agents.logger}}(mode="write", summary="agent:<agent_name> created")
