...
## 14. Theme Enforcement

All components must comply with the standards defined in this document. The code-reviewer agent validates theme compliance during:
- `/sdd-task --execute` operations
- `/sdd-task --update` modifications
- `/sdd-task --review` checks

Non-compliant code will be flagged with specific references to the violated standards above.
