...
6. Use `/sdd-task --spec <feature> <description>` for new SDDs (dashboard prompts for UI focus).
...
- "Create a spec for user login" → /sdd-task --spec "User Login" "Create responsive login form with validation"
